...
// labour (£120/hr) plus typical parts. The exact figure is always confirmed on
...
export const LABOUR_RATE = 120; // £/hr, minimum 1 hour
...
export const deviceCategories: DeviceCategory[] = [
  {
    ...
    faults: [
      ...
      { id: 'no-power', label: "Won't turn on / no power", min: 120, max: 300, note: 'Diagnosis first — logic board faults quoted after inspection.' },
      { id: 'liquid', label: 'Liquid / water damage', min: 150, max: 400, note: 'Depends on corrosion — assessed on site.' },
      { id: 'slow', label: 'Slow / macOS / virus', min: 120, max: 150, remoteFixable: true },
  ...
  },
  {
    ...
    faults: [
      ...
      { id: 'battery', label: 'Battery replacement', min: 120, max: 180 },
      { id: 'no-power', label: "Won't turn on / no power", min: 120, max: 250 },
      { id: 'liquid', label: 'Liquid / water damage', min: 120, max: 300 },
      { id: 'slow', label: 'Slow / virus removal / reinstall', min: 120, max: 150, remoteFixable: true },
      { id: 'charging', label: 'Charging port / DC jack', min: 120, max: 200 },
      { id: 'keyboard', label: 'Keyboard replacement', min: 120, max: 220 },
  ...
  },
  {
    ...
    faults: [
      { id: 'no-power', label: "Won't turn on / no display", min: 120, max: 300 },
      { id: 'overheat', label: 'Overheating / cleaning / repaste', min: 120, max: 180 },
      { id: 'slow', label: 'Slow / virus / Windows reinstall', min: 120, max: 180, remoteFixable: true },
  ...
  },
  {
    ...
    faults: [
      ...
      { id: 'no-power', label: "Won't power on", min: 120, max: 250 },
      { id: 'overheat', label: 'Overheating / fan / cleaning', min: 120, max: 180 },
      { id: 'disc', label: 'Disc drive not reading', min: 120, max: 220 },
      { id: 'drift', label: 'Controller / joystick drift', min: 120, max: 180 },
    ],
  },
];
