...
export const services: Service[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'How much is a MacBook battery replacement, and how long does it take?', a: 'You pay our £100 per hour labour, usually within the hour, plus the cell itself, both quoted upfront. Most replacements are finished on-site in a single visit across Greater London, so you keep your Mac the same day rather than losing it for a week.' },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'What does liquid damage repair cost?', a: 'It depends on what the liquid reached, so the diagnosis is free and the quote comes before any work — our £100 per hour labour plus any parts the board needs. Sugary drinks and alcohol are more aggressive than water and often mean more work. If we cannot recover the machine, there is nothing to pay.' },
    ],
  },
  {
